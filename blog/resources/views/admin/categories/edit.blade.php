...
<div class="col-md-12 pl-0" >
    ...
    <div class="bg-light col-md-9 offset-md-1 p-2" style="height: 550px; border-radius:14px">
      ...
      <div class="panel panel-default">
         <div class="panel heading">
           modifier categorie: {{ $category->name }}
         </div>
    ...
    <form action="{{ route('update',['id'=>$category->id]) }}" method="POST">
         ...
         <div class="form-group">
           ...
           <input type="text" name="name" class="form-control" value="{{ $category->name }}" id="exampleFormControlInput1" placeholder="title">
          </div>
          
          
          <button class="btn btn-primary offset-md-5" type="submit">modifier</button>
        </form>
